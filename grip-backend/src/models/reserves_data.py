...
class ReservesData(db.Model):
    ...
    def __repr__(self):
        return f'<ReservesData {self.commodity_id}-{self.country_id}-{self.year}>'
    ...
    def to_dict(self):
        return {
            ...
            'year': self.year,
            'reserves_volume': float(self.reserves_volume) if self.reserves_volume else None,
            'unit': self.unit,
