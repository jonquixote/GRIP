#!/usr/bin/env python3
"""
Test script for enhanced FRED collector in main environment
"""
...
def test_enhanced_collector():
    print("Testing enhanced FRED collector in main environment...")
    ...
    try:
        ...
        if result['success']:
            ...
            commodities_to_test = ['copper', 'aluminum']
